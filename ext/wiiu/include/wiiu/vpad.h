...
{
    VPAD_TOUCH_RESOLUTION_1920x1080,
    VPAD_TOUCH_RESOLUTION_1280x720,
    VPAD_TOUCH_RESOLUTION_854x480
} VPADTouchResolution;
...
void VPADGetTPCalibratedPointEx(uint32_t chan, VPADTouchResolution resolution, VPADTouchData *calibratedData, VPADTouchData *uncalibratedData);

typedef void(*samplingCallback)(s32  chan);
samplingCallback VPADSetSamplingCallback(s32 chan, samplingCallback callback);
